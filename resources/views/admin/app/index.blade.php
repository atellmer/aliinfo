...
<head>
	...
	<title>ЧТО Я НАШЕЛ НА АЛИЭКСПРЕСС</title>
	...
	<meta property="og:url" content="http://aliinfo.ru">
	<meta property="og:type" content="website">
	<meta property="og:title" content="Aliinfo | Что я нашел на Алиэкспресс">
	<meta property="og:description" content="Description">
	<meta property="og:image" content="public/client/img/social.jpg">
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:site" content="@aliinfo">
	<meta name="twitter:creator" content="@aliinfo">
	<meta name="twitter:title" content="aliinfo.ru">
	<meta name="twitter:description" content="Description">
	<meta name="twitter:image" content="public/client/img/social.jpg">
...
<body>
	<style>
		.admin-panel {
			...
			padding: 20px;
			border-radius: 3px;
			box-shadow: 0 3px 10px rgba(0,0,0,0.16), 0 3px 10px rgba(0,0,0,0.23)!important;
		}
		.admin-panel a{
			margin: 0 20px;
			color: #FFF;
